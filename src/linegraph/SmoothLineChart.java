...
public class SmoothLineChart<X,Y> extends LineChart<X,Y> {

	public SmoothLineChart(Axis arg0, Axis arg1) {
		super(arg0, arg1);
		// TODO Auto-generated constructor stub
	}
	
	public SmoothLineChart(Axis xAxis, Axis yAxis,ObservableList list) {
		super(xAxis,yAxis,list);
	}
	 ...
	 @Override protected void layoutPlotChildren() {
		 super.layoutPlotChildren();
	        for (int seriesIndex=0; seriesIndex < getDataSize(); seriesIndex++) {
	            ...
	            smooth(((Path)series.getNode()).getElements());
	}
